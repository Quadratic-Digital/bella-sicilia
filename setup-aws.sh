...
echo "     --domain-name bellasicilia.quadratic-digital.com \\"
...
echo "   - Alternate domain: bellasicilia.quadratic-digital.com"
echo "   - SSL: Use ACM certificate"
echo "   - Default root object: index.html"
echo ""
echo "4. 🌐 Update DNS:"
echo "   Add CNAME: bellasicilia → d123abc.cloudfront.net"
echo ""
